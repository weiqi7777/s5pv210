...
#define GPG3CON_REG 	(*(volatile unsigned int *)0xe02001e0) 
#define GPG3PUD_REG 	(*(volatile unsigned int *)0xe02001e8) 
#define GPG3DRV_REG 	(*(volatile unsigned int *)0xe02001ec) 
